...
**local-7 실행 결과 (best-view baseline reuse):**
...
- `dlink-dir825b1-cve-2017-6190` → vulnerable=`fn`, patched=`tn`
- `dlink-dir825c1-cve-2019-6257` → vulnerable=`fn`, patched=`tn`
- `tplink-archerc7v2-cve-2017-13772` → vulnerable=`fn`, patched=`tn`
- `tplink-archerc7v4-cve-2019-17152` → vulnerable=`fn`, patched=`tn`
- aggregate: **recall 0.142857 / false-positive rate 0.142857**
