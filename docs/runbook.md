...
- **Exploit Candidate Map**: visual distribution of `high/medium/low` candidates from `stages/findings/exploit_candidates.json` plus top candidate paths; use this to prioritize manual chain validation.
